...
async function main() {
  ...
  if (existingInventory === 0) {
    await prisma.inventoryItem.createMany({
      data: [
        { tenantId: tenant.id, name: 'Basmati Rice', unit: 'kg', currentStock: 50, minimumStock: 10, costPrice: 80 },
        { tenantId: tenant.id, name: 'Toor Dal', unit: 'kg', currentStock: 20, minimumStock: 5, costPrice: 120 },
        { tenantId: tenant.id, name: 'Sunflower Oil', unit: 'litre', currentStock: 30, minimumStock: 10, costPrice: 150 },
        { tenantId: tenant.id, name: 'Onion', unit: 'kg', currentStock: 25, minimumStock: 5, costPrice: 40 },
        { tenantId: tenant.id, name: 'Tomato', unit: 'kg', currentStock: 20, minimumStock: 5, costPrice: 50 },
        { tenantId: tenant.id, name: 'Potato', unit: 'kg', currentStock: 15, minimumStock: 5, costPrice: 35 },
        { tenantId: tenant.id, name: 'Paneer', unit: 'kg', currentStock: 8, minimumStock: 3, costPrice: 350 },
        { tenantId: tenant.id, name: 'Chicken (Whole)', unit: 'kg', currentStock: 15, minimumStock: 5, costPrice: 200 },
        { tenantId: tenant.id, name: 'Mutton', unit: 'kg', currentStock: 8, minimumStock: 3, costPrice: 600 },
        { tenantId: tenant.id, name: 'Eggs', unit: 'piece', currentStock: 100, minimumStock: 30, costPrice: 6 },
        { tenantId: tenant.id, name: 'Garam Masala', unit: 'kg', currentStock: 2, minimumStock: 0.5, costPrice: 500 },
        { tenantId: tenant.id, name: 'Turmeric Powder', unit: 'kg', currentStock: 1, minimumStock: 0.3, costPrice: 200 },
        { tenantId: tenant.id, name: 'Red Chilli Powder', unit: 'kg', currentStock: 2, minimumStock: 0.5, costPrice: 300 },
        { tenantId: tenant.id, name: 'Coriander Leaves', unit: 'kg', currentStock: 3, minimumStock: 1, costPrice: 80 },
        { tenantId: tenant.id, name: 'Mint Leaves', unit: 'kg', currentStock: 2, minimumStock: 0.5, costPrice: 60 },
        { tenantId: tenant.id, name: 'Ginger', unit: 'kg', currentStock: 3, minimumStock: 1, costPrice: 100 },
        { tenantId: tenant.id, name: 'Garlic', unit: 'kg', currentStock: 3, minimumStock: 1, costPrice: 80 },
        { tenantId: tenant.id, name: 'Curd', unit: 'kg', currentStock: 10, minimumStock: 3, costPrice: 60 },
        { tenantId: tenant.id, name: 'Butter', unit: 'kg', currentStock: 5, minimumStock: 2, costPrice: 400 },
        { tenantId: tenant.id, name: 'Naan Flour', unit: 'kg', currentStock: 15, minimumStock: 5, costPrice: 45 },
      ],
    });
