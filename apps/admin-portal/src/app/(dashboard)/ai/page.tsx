...
export default function AiTenantPicker() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="AI Dashboard" description="Select a restaurant to view its AI insights and demand forecasts" />
      <Input
          ...
          tenants.map((t) => (
            <Card key={t.id} className="p-4 hover:border-primary transition-colors cursor-pointer"
              ...
              <Button variant="outline" size="sm" className="mt-3 w-full"
                onClick={(e) => { e.stopPropagation(); router.push(`/ai/${t.id}`); }}>
                Open AI Dashboard
              </Button>
            </Card>
          ))
